...
import { StreamingReplyCountItem } from "@/components/chat/streaming-reply-count-item";
import { MoodCareToggleItem } from "@/components/chat/mood-care-toggle-item";
        ...
        <PageShell title="聊天信息" onBack={onClose} className="absolute inset-0 z-[100]">
            <div className="page-menu chat-info-menu">
                ...
                <div className="menu-group">
                    ...
                    <MoodCareToggleItem sessionId={session.id} />
